...
"""
# ___ Modifier les path en fonction de ce que vous voulez ___#
ap = argparse.ArgumentParser()
ap.add_argument("-i", "--input", default="data/raw/lip_reading_dlib/sample_video.mp4",
                help="path to input video file")
ap.add_argument("-o", "--output", default="data/raw/lip_reading_dlib/sample_video_traite.mp4",
...
# ___ Modif pour avoir les droits ___ #
output_dir = os.path.dirname(args["output"])
if not os.path.exists(output_dir) and output_dir != '':
    os.makedirs(output_dir)

mouth_destination_path = os.path.join(output_dir if output_dir != '' else os.getcwd(), 'mouth')
if not os.path.exists(mouth_destination_path):
    os.makedirs(mouth_destination_path)
